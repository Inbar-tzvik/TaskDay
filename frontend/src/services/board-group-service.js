...
function _createBoard() {
    ...
    if (!boards || !boards.length) {
        boards = [
            { _id: utilService.makeId(), name: 'Fiat', price: 30, lables: ["Funny"], inStock: true, reviews: ['nice board', 'bad board'] },
            { _id: utilService.makeId(), name: 'Honda', price: 87, lables: ["Funny"], inStock: false, reviews: ['nice board', 'bad board'] },
            { _id: utilService.makeId(), name: 'Toyota', price: 54, lables: ["Sad"], inStock: true, reviews: ['nice board', 'bad board'] },
        ]
