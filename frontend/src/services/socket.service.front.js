...
socketService.on('chat topic', ((toy_id) =>
    ...
    console.log('to_id from front', toy_id)
))
...
// socketService.on('chat topic', topic => {
//     if (socketService.myTopic === topic) return;
//     if (socketService.myTopic) {
//         console.log('socketService.myTopic', socketService.myTopic);
//         socketService.leave(socketService.myTopic)
//     }
//     socketService.join(topic)
//     socketService.myTopic = topic
//   })
